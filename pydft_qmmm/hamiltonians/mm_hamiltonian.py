...
class MMHamiltonian(PotentialHamiltonian):
    ...
    """
    theory_level: TheoryLevel = TheoryLevel.MM

    def __init__(
            self,
            interface: str = "openmm",
    ...
    def build_calculator(self, system: System) -> PotentialCalculator:
        ...
        if interface_info[0] != self.theory_level:
            raise TheoryLevelError(
                self.theory_level,
                interface_info[0],
                "interface specified for the MMHamiltonian object",
        ...
        calculator.calculator_group = "MM"
        return calculator
